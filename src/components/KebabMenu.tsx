 ...
 * 케밥 메뉴 컴포넌트
 */
const KebabMenu = ({ menus }: KebabMenuProps) => {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {open && (
        <div className="absolute right-0 z-50 mt-2 flex w-30 flex-col rounded border border-[var(--color-border)] bg-white text-sm font-medium shadow-lg">
          {menus.map((menu) => (
            <button
              key={menu.value}
