...
const KebabMenuIcon = ({ className = '' }: KebabMenuIconProps) => {
  return (
    <svg
      width="24"
      height="24"
    ...
    >
      <path
        d="M12 4C11.1716 4 10.5 4.67157 10.5 5.5C10.5 6.32843 11.1716 7 12 7C12.8284 7 13.5 6.32843 13.5 5.5C13.5 4.67157 12.8284 4 12 4Z"
        fill="currentColor"
      />
      <path
